(function() {
  ...
  markdown = require('front-matter-markdown/lib/markdown');

  getTocFromList = require('front-matter-markdown/lib/markdown/get-toc-from-list');

  getToc = require('front-matter-markdown/lib/markdown/get-toc-from-heading');

  headingFilter = require('front-matter-markdown/lib/gen-heading-filter');
